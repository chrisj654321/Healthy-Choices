 ...
 *
 * Usage:
 *   node scripts/next-batch.js --n 15
 *   node scripts/next-batch.js --n 15 --queue path/to/other-queue.csv
 *
...
function main() {
  ...
  if (!Number.isFinite(n) || n <= 0) {
    console.error('Usage: node scripts/next-batch.js --n <count> [--queue <path>]');
    process.exit(1);
  }
