 ...
 *
 * Run this after any rebuild (`node scripts/catalog-database/build-products-sqlite.js`) that
 ...
 *
 * Usage:
 *   node scripts/catalog-database/upload-products-db.js
 *
...
async function main() {
  ...
  if (!fs.existsSync(DB_PATH)) {
    throw new Error(`Database not found: ${path.relative(ROOT, DB_PATH)} — run scripts/catalog-database/build-products-sqlite.js first`);
  }
