...
$commands = @(
    ...
    'scripts/ingest-products.js --batch=200 --source=usda --query="macaroni and cheese"',
    'scripts/ingest-products.js --batch=200 --source=usda --query="granola bar"',
    'scripts/ingest-products.js --batch=200 --source=usda --query="pasta sauce"',
    'scripts/ingest-products.js --batch=200 --source=usda --query="salad dressing"',
    'scripts/ingest-products.js --batch=200 --source=usda --query="breakfast cereal"',
    'scripts/ingest-products.js --batch=200 --source=usda --query="whole grain bread"',
    'scripts/ingest-products.js --batch=200 --source=usda --query="frozen pizza"',
    'scripts/ingest-products.js --batch=200 --source=usda --query="frozen vegetables"',
    'scripts/ingest-products.js --batch=200 --source=usda --query="canned soup"',
    'scripts/ingest-products.js --batch=200 --source=usda --query="mixed nuts"',
    'scripts/ingest-products.js --batch=200 --source=usda --query="energy drink"',
    'scripts/ingest-products.js --batch=200 --source=usda --query="canned beans"',
    'scripts/ingest-products.js --batch=200 --source=usda --query="ice cream"',
    'scripts/ingest-products.js --batch=200 --source=usda --query="cream cheese"',
    'scripts/ingest-products.js --batch=200 --source=usda --query="snack mix"',
    'scripts/ingest-products.js --batch=200 --source=usda --query="hot sauce"',
    'scripts/ingest-products.js --batch=200 --source=usda --query="protein bar"',
    'scripts/ingest-products.js --batch=200 --source=usda --query="frozen chicken"',
    'scripts/ingest-products.js --batch=200 --source=usda --query="fruit snacks"',
    'scripts/ingest-products.js --batch=200 --source=usda --query="sports drink"'
)
