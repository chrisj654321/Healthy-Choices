 ...
 *
 * Usage:
 *   node scripts/ingredients/merge-score-changes.js              # dry run (default, no writes)
 *   node scripts/ingredients/merge-score-changes.js --dry-run    # dry run (explicit)
 *   node scripts/ingredients/merge-score-changes.js --apply      # write ingredients.js and ingredientCache.js
 *
