...
11. **Repo file audit** (founder-flagged 2026-07-22) — rename things for clarity, remove old/dead files, sort/organize the tree. Explicitly deferred, not scoped yet. The `.easignore` cleanup that same day (marketing/, batches/, unused mascot masters) is a preview of the kind of thing this would catch more of.
